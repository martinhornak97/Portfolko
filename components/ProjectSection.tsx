  ...
  return (
    <div className="w-full bg-white">
      <div className="max-w-[1600px] mx-auto px-4 md:px-20">
        <Link 
          href={`/projects/${slug}`}
          className="group flex flex-col lg:flex-row justify-between items-center gap-12 lg:gap-24 w-full py-16 hover:opacity-90 transition-opacity cursor-pointer"
        >
          {/* TEXT */}
          <div className="w-full flex-1 min-w-[300px] max-w-[400px] text-center lg:text-left">
